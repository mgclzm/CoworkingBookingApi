...
def _convert_user_model_to_entity(user_model: AppUserModel) -> AppUser:
    ...
    return AppUser(name, email, password, user_model.is_active, 
                   user_id=user_model.user_id, creation_time=user_model.creation_time)
...
def _convert_user_entity_to_model(user: AppUser) -> AppUserModel:
    ...
    return AppUserModel(user_id=user_id, firstname=firstname, lastname=lastname,
                        email=email, password=password, creation_time=creation_time, is_active=is_active)
