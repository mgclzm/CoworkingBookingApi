...
def _convert_refresh_token_entity_to_model(
...
def _convert_refresh_token_model_to_entity(
    ...
    return RefreshToken(
        user_id, expires_at, revoked, token_id=token_id, created_at=created_at
    )
